...
***************************************************************************** */
var t,n,r,o}),[T,i]);return n.useEffect((function(){E.current&&p(new o.Player(E.current))}),[E]),n.useEffect((function(){l&&u&&(l.$on(exports.EVENT_TYPES.CLEAR,(function(){u(exports.EVENT_TYPES.CLEAR)})),l.$on(exports.EVENT_TYPES.END,(function(){u(exports.EVENT_TYPES.END)})),l.$on(exports.EVENT_TYPES.PAUSE,(function(){u(exports.EVENT_TYPES.PAUSE)})),l.$on(exports.EVENT_TYPES.PROCESS,(function(){u(exports.EVENT_TYPES.PROCESS)})),l.$on(exports.EVENT_TYPES.START,(function(){u(exports.EVENT_TYPES.START)})),l.$on(exports.EVENT_TYPES.STOP,(function(){u(exports.EVENT_TYPES.STOP)})))}),[l,u]),n.useEffect((function(){l&&s&&P&&(l.clear(),a||(l.set(s),l.mount(P),l.start()))}),[l,s,P,a]),n.useEffect((function(){b(t)}),[b,t]),n.useEffect((function(){}),[l,T,i,t]),r.createElement("canvas",{ref:E,className:c})};
